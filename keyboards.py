...
def get_premium_keyboard(has_premium: bool = False, expires_at = None) -> InlineKeyboardMarkup:
    ...
    if not has_premium:
        keyboard.append([InlineKeyboardButton(text="💳 1 месяц - 100⭐", callback_data="buy_premium:1")])
        keyboard.append([InlineKeyboardButton(text="💳 3 месяца - 250⭐", callback_data="buy_premium:3")])
        keyboard.append([InlineKeyboardButton(text="💳 6 месяцев - 450⭐", callback_data="buy_premium:6")])
        keyboard.append([InlineKeyboardButton(text="💳 1 год - 800⭐", callback_data="buy_premium:12")])
